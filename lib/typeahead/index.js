...
var Typeahead = React.createClass({displayName: "Typeahead",
  ...
  _renderIncrementalSearchResults: function() {
    ...
    if (this.state.selection) {
	  ...
	  console.log('_renderIncrementalSearchResults');
  ...
  getSelection: function() {
    var index = this.state.selectionIndex;
	  console.log('getSelection', index, this.state.visible, 'got', this.state.visible[index]);
    //if (this._hasCustomValue()) {
      //if (index === 0) {
        //return this.state.entryValue;
      //} else {
  ...
  _generateFilterFunction: function() {
	...
	if(this.props.filterOptions && typeof this.props.filterOptions === 'function'){
		return this.props.filterOptions;
	} else if (typeof filterOptionProp === 'function') {
	  return filterOptionProp;
      //return function(value, options) {
		  //console.log('blaaaaaaa', value, options);
      ...
      return function(value, options) {
        return fuzzy
          .filter(value, options, {extract: mapper, pre: "<strong>", post: "</strong>"})
